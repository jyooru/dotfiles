    ...
    home-manager.users.joel = {
      services = {
        ...
        ''; # smart resize
            ...
            # system
            "super + {_,alt + } Escape" = ''XSECURELOCK_PASSWORD_PROMPT=asterisks XSECURELOCK_FONT="FiraCode Nerd Font:style=Regular" xsecurelock {_, & sleep 0.1 && systemctl suspend}''; # lock / and suspend
